...
gmd(
  ...
  async (from, Gifted, conText) => {
    ...
    try {
      ...
      let sourceName = botName || "𝐈ᴍᴍυ Mᴅ";
      ...
      const forwardContextInfo = {
        ...
        isForwarded: true,
        forwardedNewsletterMessageInfo: {
          newsletterJid: newsletterJid || "120363341506278064@newsletter",
  ...
  async (from, Gifted, conText) => {
    ...
    try {
      ...
      if (!sudoList || !sudoList.length) {
        return reply(
          "⚠️ No sudo users added yet.\nUse .setsudo @user or .setsudo 923493114170 to add sudo users.",
        );
      }
