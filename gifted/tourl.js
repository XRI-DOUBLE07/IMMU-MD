...
async function handleUpload(from, Gifted, conText, service) {
    ...
    try {
        ...
        if (quotedImg) {
            ...
            if (service === 'pixhost') {
                return reply(`❌ ${service} does not support sticker uploads. Use ${botPrefix}imgbb, ${botPrefix}catbox, ${botPrefix}immucdn or ${botPrefix}githubcdn instead.`);
            }
            ...
            if (service !== 'catbox' && service !== 'giftedcdn' && service !== 'githubcdn') {
                return reply(`❌ ${service} only supports images. Use ${botPrefix}catbox or ${botPrefix}immucdn or ${botPrefix}githubcdn  for documents and any other file type.`);
            }
        ...
        if (!isImage && service !== 'catbox' && service !== 'giftedcdn' && service !== 'githubcdn') {
            return reply(`❌ ${service} only supports image files. Use ${botPrefix}catbox or ${botPrefix}immucdn or ${botPrefix}githubcdn for any other file types.`);
        }
