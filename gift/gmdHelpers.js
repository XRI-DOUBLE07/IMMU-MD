...
const createContext = async (userJid, options = {}) => {
    const botName = (await getSetting("BOT_NAME")) || "𝐈ᴍᴍυ Mᴅ";
    const botPic =
        (await getSetting("BOT_PIC")) ||
        "https://i.postimg.cc/Px2sSHyB/IMG-20260408-WA0004.png";
    const newsletterJid =
        (await getSetting("NEWSLETTER_JID")) || "120363341506278064@newsletter";
    const newsletterUrl =
    ...
    return {
        contextInfo: {
            ...
            externalAdReply: {
                ...
                body: options.body || "Powered by 𝐈ᴍᴍυ Mᴅ",
                thumbnailUrl: botPic,
                mediaType: 1,
